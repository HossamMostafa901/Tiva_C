...
/*there are three state in this program one is no uart second is listiening or sending third is chat*/
/*diffrent led will be on in each state to know in which state we in it */
#include "uart_config.h"

#define ARRAY_SIZE   200
/*choose one state in second state sending or recving and opposite computer will choose the oppoite one*/
#define SENDER_ECU
...
int main(void)
{
    ...
    while(1)
    {
        ...
        {
            if(flag2 == 1)
            {/*we end evry string with # to konw it finsh sending*/
...
/*switch between state using interput handler*/
    switch(count)
    {
    case 0:
        count =1;break;
